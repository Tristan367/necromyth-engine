...
struct FrameUniformBufferObject {
  ...
  alignas(16) std::array<glm::mat4, 6> point_light_vp{}; // indices 6-11, clip space (vertex shader)
  alignas(16) std::array<glm::mat4, 6> point_light_shadow_mtx{}; // UV space (fragment shader)
